...
const TableOne = () => {
    return (
        <div className="rounded-md border-white/20 border-2 bg-darkGreen px-5 pt-6 pb-2.5 shadow-default border-strokedark bg-boxdark sm:px-7.5 xl:pb-1">
        <h4 className="mb-6 text-xl font-semibold text-white">
            Top Channels
        </h4>

        <div className="flex flex-col">
            <div className="grid grid-cols-3 rounded-md bg-white/10 sm:grid-cols-5">
            ...
            <div
                ...
                key === brandData.length - 1
                    ? ''
                    : 'border-b border-stroke border-black'
                }`}
                key={key}
            >
                ...
                <div className="flex items-center justify-center p-2.5 xl:p-5">
                <p className="text-primaryGreen">${brand.revenues}</p>
                </div>
                ...
                <div className="hidden items-center justify-center p-2.5 sm:flex xl:p-5">
                <p className="text-[#007ced]">{brand.conversion}%</p>
                </div>
            </div>
            ))}
        </div>
